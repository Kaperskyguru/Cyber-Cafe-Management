...
public class Goods_Services_Stocks extends javax.swing.JFrame {

    static DatabaseClass DB = new DatabaseClass();
    private final TableRowSorter<TableModel> sorter;

    public Goods_Services_Stocks() {
        initComponents();
        getStoreItem();
    ...
    private void initComponents() {
        ...
        setTitle("Goods. Services. Stocks");
        setBackground(new java.awt.Color(255, 255, 255));
        setPreferredSize(new java.awt.Dimension(459, 514));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int item = jTable2.getSelectedRow();

    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new NewItem(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Goods_Services_Stocks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        /* Create and display the dialog */
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Goods_Services_Stocks dialog = new Goods_Services_Stocks();
    ...
    public static void getStoreItem() {
        ...
        header.add("Price");
        jTable2.setModel(new DefaultTableModel(DatabaseClass.getStoreItem(), header));
