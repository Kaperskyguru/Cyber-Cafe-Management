...
public class SaleTo extends javax.swing.JDialog {

    public SaleTo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        getStoreItem();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Standard", "Employee", "60 min = 10", "Student" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SaleTo dialog = new SaleTo(new javax.swing.JFrame(), true);
...
private void getStoreItem() {
        ...
        header.add("Price");
        jTable1.setModel(new DefaultTableModel(DatabaseClass.getStoreItem(), header));
